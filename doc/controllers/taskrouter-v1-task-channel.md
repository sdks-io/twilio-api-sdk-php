...
```php
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
```
...
```php
function fetchTaskChannel(string $workspaceSid, string $sid): ApiResponse
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`TaskChannel`](../../doc/models/task-channel.md).
...
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
$apiResponse = $taskrouterV1TaskChannelApi->fetchTaskChannel(
    $workspaceSid,
    $sid
);
...
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
$apiResponse = $taskrouterV1TaskChannelApi->updateTaskChannel(
    $workspaceSid,
    $sid,
    $friendlyName,
...
```php
function deleteTaskChannel(string $workspaceSid, string $sid): ApiResponse
```
...
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
$apiResponse = $taskrouterV1TaskChannelApi->deleteTaskChannel(
    $workspaceSid,
    $sid
);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`ListTaskChannelResponse`](../../doc/models/list-task-channel-response.md).
...
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
$apiResponse = $taskrouterV1TaskChannelApi->listTaskChannel($workspaceSid);
...
$taskrouterV1TaskChannelApi = $client->getTaskrouterV1TaskChannelApi();
$apiResponse = $taskrouterV1TaskChannelApi->createTaskChannel(
    $workspaceSid,
    $friendlyName,
    $uniqueName
);
