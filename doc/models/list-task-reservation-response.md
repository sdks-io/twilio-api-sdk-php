...
# List Task Reservation Response
...
|  --- | --- | --- | --- | --- | --- |
| `reservations` | [`?(TaskReservation[])`](../../doc/models/task-reservation.md) | Optional | - | getReservations(): ?array | setReservations(?array reservations): void |
