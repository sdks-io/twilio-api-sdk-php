...
# List Credential Public Key Response
...
|  --- | --- | --- | --- | --- | --- |
| `credentials` | [`?(CredentialPublicKey[])`](../../doc/models/credential-public-key.md) | Optional | - | getCredentials(): ?array | setCredentials(?array credentials): void |
